...
export interface ApiBlogSettingBlogSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    maintenance_mode: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    moderate_comments: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    newsletter_enabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    report_reason: Schema.Attribute.Enumeration<
...
export interface ApiNewsletterNewsletter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    preferences: Schema.Attribute.Component<
      'shared.newsletter-preferences',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.Enumeration<
      ['website', 'social', 'referral', 'api', 'import']
    > &
