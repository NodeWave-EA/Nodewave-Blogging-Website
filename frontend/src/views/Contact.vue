      ...
      <div class="container mx-auto px-4 max-w-6xl">
        <div
          :class="[
            'grid',
            'grid-cols-1',
            hasCompanyInfo ? 'lg:grid-cols-2' : 'lg:grid-cols-1',
            'gap-12',
            !hasCompanyInfo ? 'justify-items-center' : '',
          ]"
        >
          ...
          <div
            :class="[
              'bg-transparent rounded-xl p-8 border border-border shadow-md w-full',
              !hasCompanyInfo ? 'mx-auto max-w-xl' : '',
            ]"
          >
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div>
                <label
                  for="subject"
                  class="block text-sm font-medium font-mono text-foreground mb-2"
                >
                  Subject *
                </label>
                <input
    ...
    <div class="mt-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <div class="rounded-lg p-6 border border-border bg-transparent">
          <h3 class="font-semibold font-mono text-foreground mb-2">How quickly do you respond?</h3>
        ...
        <div class="rounded-lg p-6 border border-border bg-transparent">
          <h3 class="font-semibold font-mono text-foreground mb-2">Can I subscribe to updates?</h3>
          <p class="text-muted-foreground text-sm font-mono">
