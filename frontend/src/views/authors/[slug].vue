  ...
  <div class="bg-transparent min-h-screen">
    ...
    <div v-else-if="author" class="py-8">
      ...
      <div class="container mx-auto px-4 mb-6">
        <nav class="flex items-center gap-2 text-sm text-black dark:text-white">
          <router-link to="/" class="hover:underline transition-colors">
            Home
          </router-link>
          <ChevronRightIcon class="w-4 h-4" />
          <router-link to="/authors" class="hover:underline transition-colors">
            Authors
          </router-link>
          <ChevronRightIcon class="w-4 h-4" />
          <span class="text-black dark:text-white">{{ author?.name }}</span>
        </nav>
      </div>
