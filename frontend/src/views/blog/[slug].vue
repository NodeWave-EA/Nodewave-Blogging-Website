    ...
    <article v-else-if="post" class="py-8">
      ...
      <div class="container mx-auto px-4 max-w-4xl">
        ...
        <RichText
          ...
          class="prose prose-lg prose-zinc dark:prose-invert max-w-none mb-12"
          :allow-iframes="true"
          :lazy-images="true"
        ...
        >
          ...
          <div class="flex items-center gap-4">
            ...
            >
              <component
                :is="liked ? HeartSolid : HeartOutline"
                class="w-5 h-5"
...
function removeStructuredDataScript() {
  try {
    ...
    console.error('Failed to remove structured data script:', e)
  }
}
...
function ensureMetaTag(prop: string, content: string | null, id: string) {
  try {
    ...
    console.error('Failed to ensure meta tag:', e)
  }
}
...
function ensureCanonical(href: string | null) {
  try {
    ...
    console.error('Failed to ensure canonical link:', e)
  }
}
...
const loadViewedSet = (): Set<number> => {
  try {
    ...
    console.error('Failed to load viewed set:', e)
    return new Set()
  }
}
...
const saveViewedSet = (s: Set<number>) => {
  try {
    ...
    console.error('Failed to save viewed set:', e)
  }
}
...
const loadLikedSet = (): Set<number> => {
  try {
    ...
    console.error('Failed to load liked set:', e)
    return new Set()
  }
}
...
const saveLikedSet = (s: Set<number>) => {
  try {
    ...
    console.error('Failed to save liked set:', e)
  }
}
</script>
