    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        ...
        <div class="flex items-center space-x-5">
          <label
            class="text-base sm:text-lg font-semibold text-slate-700 dark:text-slate-300 whitespace-nowrap"
          >
            Filter by:
          </label>
      ...
      <!-- Active Filters -->
      <div v-if="hasActiveFilters" class="mt-10" data-aos="fade-up" data-aos-delay="200">
      ...
      >
        <p
          class="inline-block px-6 py-3 text-base font-semibold text-slate-700 dark:text-slate-300 bg-transparent border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm"
        >
          {{ resultsSummaryText }}
        </p>
      </div>
