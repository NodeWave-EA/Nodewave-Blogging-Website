<template>
  <div class="fixed inset-0 -z-50 overflow-hidden">
    ...
    <div
      v-if="showTexture"
      class="absolute inset-0 opacity-[0.015] mix-blend-overlay transition-opacity duration-500"
    ...
    <div
      v-if="showGrid"
      class="absolute inset-0 opacity-5 transition-opacity duration-500"
      :style="gridPattern"
    />
  </div>
</template>
