        ...
        <div class="py-2">
          <button v-for="option in themeOptions" :key="option.value" @click="selectTheme(option.value)"
            ...
            <div
              ...
              <component :is="getThemeIcon(option.value)" class="w-4 h-4 transition-all duration-200" :class="{
            ...
            <div class="flex-grow min-w-0">
              <div class="font-medium text-sm text-zinc-900 dark:text-zinc-100 transition-colors duration-200">
                {{ option.label }}
              </div>
            ...
            <!-- Check Icon -->
            <CheckIcon v-if="theme === option.value"
