  ...
  <section class="py-16 bg-zinc-50 dark:bg-zinc-900/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12" data-aos="fade-up">
        ...
        <div class="mt-6 w-24 h-1 bg-gradient-to-r from-green-600 to-blue-600 mx-auto rounded-full"></div>
      </div>

      <!-- Categories Grid -->
      <div v-if="loading" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div v-for="n in 8" :key="n" class="animate-pulse">
          <div class="bg-white dark:bg-zinc-800 rounded-xl p-6 h-32 flex flex-col items-center justify-center">
      ...
      <div v-else-if="categories.length > 0" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        >
          <div class="text-center">
            <!-- Category Icon -->
            <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
            ...
            <!-- Category Name -->
            <h3 class="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
              {{ category.name }}
            </h3>
      ...
      <!-- View All Button -->
      <div v-if="categories.length > 0" class="text-center mt-12" data-aos="fade-up" data-aos-delay="300">
        <router-link
          to="/categories"
        ...
        >
          ...
          <div class="absolute inset-0 rounded-full bg-gradient-to-r from-green-600 to-blue-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
        </router-link>
      </div>
    </div>
  </section>
...
<parameter name="filePath">c:\Users\zero\DEVHOME\Nodewave-Blogging-Website\frontend\src\components\sections\CategoriesSection.vue
